...
import aboutImage from '../assets/abouts.jpeg'; // Correct relative path
    ...
    return (
        ...
        >
            <div className="lg:w-2/3 lg:pr-12">
                ...
                >
                    {showDetails ? "Hide Details" : "Why Choose biZmapia?"}
                </motion.button>
                ...
                {showDetails && (
                    ...
                    >
                        {[
                            "Massive Local Reach: Tap into BiZmapia's vast network of users actively searching for businesses in your city.",
